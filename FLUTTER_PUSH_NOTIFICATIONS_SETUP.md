...
3. ✅ Database column added: `customers.fcm_device_token`
4. ✅ API endpoint created: `/api/customer/register-device` (stores device tokens)
5. ✅ Notification sender utility created: `send-notification.ts`
6. ✅ Both status update endpoints now send notifications:
...
6. **Check customer's phone** for push notification 📱
