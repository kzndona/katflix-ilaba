      ...
      return {
        ...
        handling: {
          pickup: {
            ...
            started_at: handling.pickup?.started_at || null,
            completed_at: handling.pickup?.completed_at || null,
          },
          delivery: {
            ...
            started_at: handling.delivery?.started_at || null,
            completed_at: handling.delivery?.completed_at || null,
          },
