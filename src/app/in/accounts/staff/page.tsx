    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="grid grid-cols-2 gap-8">
          ...
          <div>
            <DetailField label="Gender" value={staff.gender ? staff.gender.charAt(0).toUpperCase() + staff.gender.slice(1) : "—"} />
            <DetailField label="Role" value={staff.role.charAt(0).toUpperCase() + staff.role.slice(1)} />
...
function EditPane({
  ...
  const hasChanges = isNewStaff || !originalStaff || JSON.stringify(staff) !== JSON.stringify(originalStaff);
  return (
    <div className="flex flex-col h-full">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          {isNewStaff && (
            <div className="col-span-2 p-4 bg-blue-50 border border-blue-200 rounded-lg text-sm text-blue-800">
              <strong>📧 Account Creation:</strong> An invitation link will be sent to the email address. Staff can set their password and activate their account through the link.
            </div>
          )}
